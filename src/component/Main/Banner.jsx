...
export default function Banner() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-cover bg-center relative" style={{ backgroundImage: `url(${backgroundImage})` }}>
      <h1 className="text-white text-4xl font-poppins font-bold text-center">
        Kamera Cerdas untuk Deteksi <br /> Konsumsi Energi Listrik (kWh)
      </h1>
      <p className="font-poppins text-center mt-3 text-white text-sm">
      ...
      <a
        href="#"
        className="bg-[#FFAA4D] hover:bg-amber-500 text-white px-4 py-2 rounded-md font-poppins font-semibold drop-shadow-md absolute bottom-10"
      >
        Cek Sekarang
      </a>
    </div>
